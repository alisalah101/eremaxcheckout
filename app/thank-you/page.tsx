  ...
  return (
    <div className="bg-[#FFFFF] min-h-[100vh] h-full w-full p-4 text-center">
      <div className="max-w-[900px] mx-auto flex flex-col items-center justify-center gap-4">
        <img className="h-[150px]" src="https://myvitaeshop.com/cdn/shop/files/Untitled_design_-_2025-12-09T165502.882.png?v=1765292127&width=120" alt="Hope Pharma" />
      ...
      {/* {product receipt} */}
        ...
        <div className="gap-0">
          ...
          <p className="text-2xl">customerservice@myvitaeshop.com</p>
        </div>
      </div>

      <div className="bg-[#F6FBFF] flex flex-col items-center justify-center w-full gap-4 py-8 mt-8 sticky top-[100%]">
        <img className="h-[80px]" src="https://myvitaeshop.com/cdn/shop/files/Untitled_design_-_2025-12-09T165502.882.png?v=1765292127&width=120" alt="Hope Pharma Logo" />
        ...
        <p className="text-xs">© 2024 vitaeshop. All rights reserved.</p>
        <p className="text-xs">customerservice@myvitaeshop.com</p>
